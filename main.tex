...
\begin{center} % Center everything in the document
	...
	\IfLanguageName{czech}{Průměr známek}{Grade average} & 1\point{}03 \IfLanguageName{czech}{}{(on a \href{https://en.wikipedia.org/wiki/Grading_systems_by_country\#Czech_Republic}{1\rangedash{}4 scale})} \\
		\IfLanguageName{czech}{Bakalářská práce}{Thesis} & \href{https://furadnik.github.io/projects/2024_bakalarka.html}{\IfLanguageName{czech}{Balancování prostorové složitosti a nejednoznačnosti superaditivních set funkcí}{Balancing Space Complexity and Ambiguity in Superadditive Set Functions}} \cite{Uradnik2024} \\
