...
% award: year, link, name, reason
\newcommand\award[4]{\bemph{\href{#2}{#3}} \hfill \gemph{#1} \\ \semph{\lng{Udělena za}{Received for} #4.}}
...
\newenvironment{work}[4] {{\bemph{#1}, \textsc{#2} \hfill \gemph{#4,\hspace{3pt} #3}}\break\small}{}
\newcommand\worksplit{\vspace{1.3em}}

\newcommand\skill[2]{ \bemph{#1.} {\small\itshape #2}}
\newcommand\skillsplit{\vspace{1.3em}}
\newcommand\schoolsplit{\vspace{1.5em}}
\newcommand\awardsplit{\vspace{1.3em}}

\newcommand\bemph[1]{\textbf{#1}}
\newcommand\cemph[1]{\textsc{#1}}
\newcommand\gemph[1]{{\gray\small\itshape #1}}
\newcommand\semph[1]{{\small #1}}

% school, faculty, place, period
\newcommand\schooltitle[4]{{\bemph{#1}\hfill \gemph{#2,\hspace{3pt} #4}\break}\textsc{#3}}
...
\begin{intro}
	\lng
	{
		...
		I am a master student of computer science at Charles University in Prague.
...
\begin{work}{REU Student Researcher}{DIMACS}{2024}{NJ, US}
	...
	\lng{Naše práce vyústila v \href{https://furadnik.github.io/projects/2025-truth-learning}{publikaci} přijatou na konferenci AAMAS 2025}
	{Our work resulted in a \href{https://furadnik.github.io/projects/2025-truth-learning}{publication} accepted to the AAMAS 2025 conference}~\cite{aamas25}.
...
\sect{\lng{Ocenění}{Awards}}

\award{2026}
{https://www.learned.cz/cz/aktivity-spolecnosti/udalosti/ucena-spolecnost-udelila-medaile-a-ceny-za-rok-2026.html}
{\lng{Cena Učené společnosti České republiky}{Prize of the Learned Society of the Czech Rep.}}
{\lng{bakalářskou práci \cite{Uradnik2024}}{my Bachelor thesis \cite{Uradnik2024}}}

\awardsplit

\award{2024}
{https://www.mff.cuni.cz/cs/kam/vyzkum/cena-jirky-matouska}
{\lng{Cena Jirky Matouška}{Jirka Matoušek Prize}}
{\lng{významnou publikaci}{an outstanding publication}~\cite{10.5555/3635637.3663047}}
...
{\lng{Magisterské, Diskrétní modely a algoritmy}{Master degree, Discrete Models and Algorithms}}{2024\rangedash{}2026}
\lng{Průměr známek}{Grade average of} 1\point{}00\lng{}{ (on a \href{https://cuni.cz/UKEN-361.html}{1\rangedash{}4 scale})}. \\
\lng{Diplomová práce na téma}{Thesis on} \href{https://furadnik.github.io/projects/2026-diplomka}{\lng{Spolehlivost sítí}{Reliability of Networks}} \cite{Uradnik2026}; \lng{Výsledek: výborně}{Grade: excellent}. \\
\lng{Předměty státní zkoušky:}{State exam subjects:} \lng
{Kombinatorika a teorie grafů, Polyedrální optimalizace, Grafové algoritmy}
{Combinatorics and graph theory, Polyhedral optimization, Graph algorithms}. \lng{Výsledek: výborně}{Grade: excellent}. \\
\lng{Získáno stipendium za vynikající studijní výsledky}{Received the scholarship for excellent study results}.
\end{school}

\schoolsplit

\begin{school}{\CharlesUni{}}{\Praha}
{\lng{Bakalářské, zaměření obecná informatika}{Bachelor degree, Theoretical Computer Science}}{2021\rangedash{}2024}
\lng{Průměr známek}{Grade average of} 1\point{}03\lng{}{ (on a \href{https://cuni.cz/UKEN-361.html}{1\rangedash{}4 scale})}. \\
\lng{Bakalářská práce na téma}{Thesis on} \href{https://furadnik.github.io/projects/2024-bakalarka}{\lng{Balancování prostorové složitosti a nejednoznačnosti superaditivních set funkcí}{Balancing Space Complexity and Ambiguity in Superadditive Set Functions}} \cite{Uradnik2024}; \lng{Výsledek: výborně}{Grade: excellent}. \\
\lng{Předměty státní zkoušky:}{State exam subjects:} \lng
...
\bemph{\LaTeX, Lua, Prolog, Haskell, Rust.}
...
\sect{\lng{Další aktivity}{Other Activities}}

\begin{tabularx}{\linewidth}{>{\raggedleft\scshape}p{2cm}X}
	2026          & \lng
	{Učil jsem cvičení k předmětu \href{https://furadnik.github.io/teaching/2526l-past}{Pravděpodobnost a statistika 1} (pro 2. ročník bakalářského studia na MFF).}
	{I taught tutorials for a \href{https://furadnik.github.io/teaching/2526l-past}{Probability and Statistics 1} course for 2\textsuperscript{nd} year undergrad students at MFF (in Czech).}
	\\
	2025          & \lng
