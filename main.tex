...
\begin{center} % Center everything in the document
	...
	{\IfLanguageName{czech}{Bakalářské, zaměření obecná informatika}{Bachelor of Science in Theoretical Computer Science}}{2021 --- \Present{} \\
		& \IfLanguageName{czech}{průměr}{GPA} 1.03 \\
		& \IfLanguageName{czech}{Pětkrát v řadě získáno stipendium za vynikající studijní výsledky}{Received the scholarship for excellent study results five times in a row}
	}

	\vspace{15pt}

	\school{Gymnázium Mimoň}{}
	{\IfLanguageName{czech}{středoškolské s maturitou}{Secondary school with \href{https://en.wikipedia.org/wiki/Matura}{maturita exam}}}{2013 --- 2021 \\
